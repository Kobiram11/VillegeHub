...
const FindNotice = () => {
  ...
  return (
    <div className="find-notice-container">
      <h2 className="find-notice-title">Find Notice by ID</h2>

      <div className="find-notice-search">
        <input
          type="text"
        ...
        <button
          ...
          className="find-notice-button"
        >
          Search
        </button>
      </div>

      {loading && <p className="find-notice-loading">Loading...</p>}
      {error && <p className="find-notice-error">{error}</p>}

      {notice && (
        <div className="notice-details-card">
          <h3 className="notice-details-title">Notice Details</h3>
