...
const statuses = ['Open']; // Changed to only include "Open"
...
export default class CreateTicket extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            assignee: '',
            priority: '',
            status: '', // Status will be set in componentDidMount
            type: '',
            users: [],
            projects: []
        };
    ...
    onSubmit(e) {
        ...
        axios.post('http://localhost:8070/tickets/create', ticket)
        ...
        this.setState({
            ...
            description: '',
            priority: '',
            status: statuses[0], // Reset to "Open"
            type: ''
        });
    }
                ...
                <form onSubmit={this.onSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <div style={{ color: 'red', marginBottom: '5px' }}>
                            If your problem is personal, you must include your email below the description.
                        </div>
                    ...
                    <div className="form-group">
                        <label>field name your issue exists in: </label>
